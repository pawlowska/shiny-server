...
```{r}
pogoda_new<-read.csv('IMGW_2017_07_10.csv')
...
write.csv(temperatura, file = "IMGW_temp_20171031.csv", fileEncoding = 'UTF-8')
...
write.csv(opady, file = "IMGW_opady_20171031.csv", fileEncoding = 'UTF-8')
```
