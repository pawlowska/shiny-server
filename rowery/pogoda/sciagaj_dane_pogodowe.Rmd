...
```{r}
poniedzialki<-lista_poniedzialkow(do=as.POSIXct("2017-06-19"))
```
...
```{r}
write.csv(chmury, file = "IMGW_chmury_20170531.csv", fileEncoding = 'UTF-8')
...
```{r}
write.csv(wiatr, file = "IMGW_wiatr_20170531.csv", fileEncoding = 'UTF-8')
