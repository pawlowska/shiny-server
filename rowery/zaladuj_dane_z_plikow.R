...
dane_dolutego2017<-fread("dane_zrodlowe/dane-20140813-20170202-poprSw.csv", encoding = 'UTF-8')
dane_dolutego2017[,Data := as.Date(Data, tz="Europe/Berlin")]

dane_domarca2017<-zaladuj_dane('dane_zrodlowe/2017styczen_marzecutf8-poprSw.csv') 
...
dane_dokwietnia2017<-zaladuj_dane('dane_zrodlowe/2017marzec_kwiecien_utf8_poprPZ-poprSw.csv', zwirki_i_wigury = FALSE) 
dane_doczerwca2017<-zaladuj_dane('dane_zrodlowe/2017kwiecien-czerwiec_utf8-poprSw.csv', zwirki_i_wigury = FALSE) 
...
dane_dolipca2017<-zaladuj_dane('dane_zrodlowe/2017_czerwiec-lipiec_poprPZ-poprSw.csv', zwirki_i_wigury = FALSE) 
...
#dane godzinowe
#pilotaz
godz_wybrane_2017<-zaladuj_dane_godzinowe('dane_zrodlowe/2017_08_05-14_06.csv', format="%y-%m-%d %H:%M", ziw=F)
