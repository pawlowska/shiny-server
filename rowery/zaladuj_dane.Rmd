...
dane_do2018=paste("dane", miasto, "dane_do2018_zsumowane_z_pogoda.csv", sep="/")
#plik_dane_long=paste(katalog, "dane_long.csv", sep="/")
#dane_polaczone=paste("dane", miasto, "dane_archiwalne_do2018.csv", sep="/")
...
dane_od2019_long<-rbind(fread("dane/Warszawa/dane20192020.csv", encoding = 'UTF-8')[Data<as.Date("2020-05-01")],
                        fread("dane/Warszawa/dane2020_od05.csv", encoding = 'UTF-8'), fill=T)
dane_od2019_long[,V1:=NULL]
dane_od2019_long[,Data:=as.Date(Data)]
dane_od2019_long<-na.omit(dane_od2019_long)

dane_od2019<-dcast(dane_od2019_long, Data ~Miejsce, fill=NA, value.var="Liczba_rowerow")
dane_od2019[,Testowy:=NULL]
dane_od2019<-numery_dat(dane_od2019)
```

```{r polacz}

dane<-rbind(dane, dane_od2019, fill=T)
```
