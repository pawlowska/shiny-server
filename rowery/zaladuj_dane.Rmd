...
```{r}
plik_pogoda_old="pliki/IMGW_pogoda_20180630.csv"
pogoda_old<-fread(plik_pogoda_old)
pogoda_old[,Data:=as.Date(Data)]
pogoda_new<-czytaj_dane_zipy(od=7, do=7, nazwa_out="pogoda/IMGW_2018_07.csv")
...
dane<-wczytaj_z_api(klucz=klucz, od="2014-08-13", do="2018-08-25")
