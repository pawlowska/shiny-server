...
```{r}
plik_pogoda_old="pliki/IMGW_pogoda_20180531.csv"
pogoda_old<-fread(plik_pogoda_old)
pogoda_old[,Data:=as.Date(Data)]
pogoda_new<-czytaj_dane_zipy(od=6, do=6, nazwa_out="pogoda/IMGW_2018_06.csv")
...
dane<-wczytaj_z_api(klucz=klucz, od="2014-08-13", do="2018-06-30")
