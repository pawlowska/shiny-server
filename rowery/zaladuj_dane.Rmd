...
```{r add new weather}
plik_pogoda_old=paste(katalog, "IMGW_pogoda_20180831.csv", sep="/")
...
```{r sciagaj dane}
dane<-wczytaj_z_api(credentials, klucz=klucz, od="2014-08-13", do="2018-10-30", miasto)
