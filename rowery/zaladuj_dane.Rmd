...
```{r}
plik_pogoda_old="pliki/IMGW_pogoda_20180228.csv"
pogoda_old<-fread(plik_pogoda_old)
pogoda_old[,Data:=as.Date(Data)]
pogoda_new<-czytaj_dane_zipy(od=3, do=3, nazwa_out="pogoda/IMGW_2018_03.csv")
...
dane<-wczytaj_z_api(klucz=klucz, od="2014-08-13", do="2018-03-31")
